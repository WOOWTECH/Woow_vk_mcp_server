...
def create_app(
    ...
    *,
    ...
    # Register extra_routers BEFORE the core settings router so that
    # target-specific settings endpoints (e.g. K3s /api/settings/mcp/status)
    # take priority over the generic process-manager-based ones.
    if extra_routers:
